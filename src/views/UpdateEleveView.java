...
public class UpdateEleveView {

	public JFrame frUpdateEleve;
	...
	public static int selectedCINEleve;
	...
	public static boolean setCin(int cin) {
		
		if(cin == 0) {
			return false;
		}else {
			selectedCINEleve = cin;
			return true;
		}
	}
	 ...
	 */
	public UpdateEleveView() {
		try {
			Eleve eleveSelect = Eleve.getEleve(selectedCINEleve);
			initialize(eleveSelect);
	 ...
	 */
	private void initialize(Eleve eleveSelect) {
		frUpdateEleve = new JFrame();
		frUpdateEleve.setTitle("Add Animateur");
		frUpdateEleve.setBackground(new Color(0, 102, 102));
		frUpdateEleve.getContentPane().setBackground(new Color(0, 102, 102));
		frUpdateEleve.getContentPane().setLayout(null);
		
		JPanel panel = new JPanel();
		panel.setBackground(new Color(204, 204, 204));
		panel.setBounds(50, 10, 680, 777);
		frUpdateEleve.getContentPane().add(panel);
		...
		String cinn = Integer.toString(eleveSelect.getCinpere());
		textCin.setText(cinn);
		...
		textNom.setText(eleveSelect.getNom_eleve());
		...
		String tell = Integer.toString(eleveSelect.getNumtel());
		textNumero.setText(tell);
		...
		String date = String.valueOf(eleveSelect.getDateNaiEleve());
		textDat_Nais.setText(date);
		...
		txt_Ville.setText(eleveSelect.getAdresseEleve().getVille());
		txt_Ville.setColumns(10);
		txt_Ville.setBounds(491, 60, 110, 37);
		panel_1_1_5.add(txt_Ville);
		
		txt_Governorat = new JTextField();
		txt_Governorat.setText(eleveSelect.getAdresseEleve().getGouvernorat());
		...
		txt_Rue.setText(eleveSelect.getAdresseEleve().getNum());
		...
		txt_Libelle.setText(eleveSelect.getAdresseEleve().getDesignation());
		txt_Libelle.setColumns(10);
		txt_Libelle.setBounds(252, 60, 110, 37);
		panel_1_1_5.add(txt_Libelle);
		
		txt_Postale = new JTextField();
		String post = String.valueOf(eleveSelect.getAdresseEleve().getCodePostal());
		txt_Postale.setText(post);
		...
		textPrenom.setText(eleveSelect.getPrenom_elve());
		...
		textPr_Pere.setText(eleveSelect.getPrmereEleve());
		...
		textPr_Gr_Pere.setText(eleveSelect.getPrgrandEleve());
		...
		textNom_Mere.setText(eleveSelect.getNommereEleve());
		...
		textPr_Mere.setText(eleveSelect.getPrmereEleve());
		...
		textImage.setText(eleveSelect.getImageProfile());
		...
		String niv = String.valueOf(eleveSelect.getNvscolaire());
		textFNiveauScolaire.setText(niv);
		textFNiveauScolaire.setColumns(10);
		textFNiveauScolaire.setBounds(172, 13, 133, 40);
		panel_1_1_1_4.add(textFNiveauScolaire);
		frUpdateEleve.setBounds(100, 100, 837, 898);
		frUpdateEleve.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		btnValider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else if (!(textFNiveauScolaire.getText().matches("[0-9]{8}"))) 
				{
				...
				frUpdateEleve.setVisible(false);
			}
		});
