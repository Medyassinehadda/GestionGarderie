...
public class UpdateAnimateurView {

	public JFrame frmUpdateAnimateur;
	...
	public static int selectedCINAnim;
	 ...
	 */
	public UpdateAnimateurView() {
		
		try {
			Animateur animateurSelect = Animateur.getAnimateur(selectedCINAnim);
			initialize(animateurSelect);
	...
	private void initialize(Animateur animateurSelect) {
		frmUpdateAnimateur = new JFrame();
		frmUpdateAnimateur.setTitle("Update Animateur");
		frmUpdateAnimateur.setBackground(new Color(0, 102, 102));
		frmUpdateAnimateur.getContentPane().setBackground(new Color(0, 102, 102));
		frmUpdateAnimateur.getContentPane().setLayout(null);
		
		JPanel panel = new JPanel();
		panel.setBackground(new Color(204, 204, 204));
		panel.setBounds(50, 10, 680, 812);
		frmUpdateAnimateur.getContentPane().add(panel);
		...
		String cinn = Integer.toString(animateurSelect.getCinAnim());
		txt_cin.setText(cinn);
		...
		txt_nom.setText(animateurSelect.getNomAnim());
		...
		txt_prenom.setText(animateurSelect.getPrenomAnim());
		...
		txt_pere.setText(animateurSelect.getPereAnim());
		...
		String tell = Integer.toString(animateurSelect.getTelAnim());
		txt_telephone.setText(tell);
		...
		String date = String.valueOf(animateurSelect.getDateNaisAnim());
		txt_datenaissance.setText(date);
		...
		txt_Ville.setText(animateurSelect.getAdresseAnim().getVille());
		txt_Ville.setColumns(10);
		txt_Ville.setBounds(491, 60, 110, 37);
		panel_1_1_5.add(txt_Ville);
		
		txt_Governorat = new JTextField();
		txt_Governorat.setText(animateurSelect.getAdresseAnim().getGouvernorat());
		...
		txt_Rue.setText(animateurSelect.getAdresseAnim().getNum());
		...
		txt_Libelle.setText(animateurSelect.getAdresseAnim().getDesignation());
		txt_Libelle.setColumns(10);
		txt_Libelle.setBounds(252, 60, 110, 37);
		panel_1_1_5.add(txt_Libelle);
		
		txt_Postale = new JTextField();
		String post = String.valueOf(animateurSelect.getAdresseAnim().getCodePostal());
		...
		txt_image.setText(animateurSelect.getImageAnim());
						...
						if(ad.updateAdresse(newAdresse))
						{
							...
							if(ac.updateAnimateur(newAnimateur))
							{
								JOptionPane.showMessageDialog(null, "Animateur modifié "
										+ " avec succès.");
								frmUpdateAnimateur.setVisible(false);
							}
						}
		...
		frmUpdateAnimateur.setBounds(100, 100, 837, 898);
		frmUpdateAnimateur.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	}
