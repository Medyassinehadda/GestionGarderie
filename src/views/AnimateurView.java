...
public class AnimateurView {
	...
	private void initialize() {
		frAnimView = new JFrame();
		frAnimView.getContentPane().setFont(new Font("Dialog", Font.BOLD, 17));
		frAnimView.getContentPane().setBackground(new Color(0, 102, 102));
		frAnimView.getContentPane().setLayout(null);
		
		JPanel panelMenu = new JPanel();
		panelMenu.setBackground(new Color(204, 204, 204));
		panelMenu.setBounds(208, 0, 304, 578);
		frAnimView.getContentPane().add(panelMenu);
		panelMenu.setLayout(null);
		
		JLabel lblGarderie = new JLabel("");
		lblGarderie.setBounds(104, 10, 96, 96);
		panelMenu.add(lblGarderie);
		frAnimView.setBackground(new Color(0, 102, 102));
		
		frAnimView.setBounds(100, 100, 693, 615);
		lblGarderie.setIcon(new ImageIcon("C:\\Users\\lenov\\Downloads\\icons8-menu-utilisateur-homme-96.png"));
		...
		frAnimView.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	}
}
